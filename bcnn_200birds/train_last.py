...
images_path = r"G:\Users\images\CUB_200_2011"
BATCH_SIZE = 4
...
# read dataset
trainset = data.MyDataset(root=images_path +r'/CUB_200_2011', is_train=True, data_len=None)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=BATCH_SIZE,
                                          shuffle=True, num_workers=0, drop_last=False)
testset = data.MyDataset(root=images_path + r'/CUB_200_2011', is_train=False, data_len=None)
...
if pretrained:
    ...
    pre_dic = torch.load(r"G:\Users\pytorch_hub_checkpoints\vgg16-397923af.pth")
